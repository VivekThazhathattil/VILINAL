...
uint checkLUMatrixRestrictions(const matrix_t *mat){
  if (mat->m < 1) {
    printf("Error: computeLU(): width/height of matrix cannot be less than 1.\n");
    return 0;
  }
  else if(mat->m != mat->n){
...
//TODO: This doesn't work if any of the diagonanl entries are 0. Use partial pivoting instead
